		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "생산실적에 따른 QR 생성",
									"targetURL": "#synceaqfruqr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceaqfruqr-display": {
								"semanticObject": "synceaqfruqr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.qfruqr",
									"url": sap.ui.require.toUrl("sync/ea/qfruqr")
								}
							}
						}
					}
